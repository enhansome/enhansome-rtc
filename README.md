...
* [RTP:Engine](https://github.com/sipwise/rtpengine) ⭐ 983 | 🐛 104 | 🌐 Perl | 📅 2026-09-08 - RTP and UDP based media traffic proxy, usable as a kernel module.
...
* [HOMER](https://github.com/sipcapture/homer) ⭐ 2,010 | 🐛 1 | 🌐 Go | 📅 2026-09-07 - Multi-protocol capturing and monitoring framework for RTC.
...
* [Fonoster](https://github.com/fonoster/fonoster) ⭐ 8,098 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-31 - Telecommunication stack built with Node.js.
...
* [libdatachannel](https://github.com/paullouisageneau/libdatachannel) ⭐ 2,734 | 🐛 149 | 🌐 C++ | 📅 2026-08-07 - Standalone WebRTC DataChannels C++ implementation.
* [libSRTP](https://github.com/cisco/libsrtp) ⭐ 1,400 | 🐛 34 | 🌐 C | 📅 2026-09-03 - Secure Real-time Transport Protocol (SRTP) library for C.
