...
* [Flexisip](https://github.com/BelledonneCommunications/flexisip) ⭐ 186 | 🐛 31 | 🌐 C++ | 📅 2026-08-11 - SIP server suite comprising proxy, presence and group chat functions.
...
* [RTP:Engine](https://github.com/sipwise/rtpengine) ⭐ 966 | 🐛 100 | 🌐 C | 📅 2026-08-14 - RTP and UDP based media traffic proxy, usable as a kernel module.
...
* [coturn](https://github.com/coturn/coturn) ⭐ 14,294 | 🐛 315 | 🌐 C | 📅 2026-08-12 - Fully featured TURN/STUN server supporting multiple platforms.
* [STUNTMAN](https://github.com/jselbie/stunserver) ⭐ 1,609 | 🐛 13 | 🌐 C++ | 📅 2026-05-12 - RFC compliant open source STUN implementation.

  ## Operations
* [natcheck](https://github.com/1mb-dev/natcheck) ⭐ 3 | 🐛 3 | 🌐 Go | 📅 2026-06-22 - NAT type diagnosis CLI. Probes STUN servers, classifies mapping behaviour per RFC 5780, and reports a WebRTC direct-P2P forecast.
* [eturnal](https://eturnal.net/) - Modern and scalable STUN/TURN server written in Erlang.

### Monitoring

* [HOMER](https://github.com/sipcapture/homer) ⭐ 2,007 | 🐛 0 | 🌐 Go | 📅 2026-08-14 - Multi-protocol capturing and monitoring framework for RTC.
* [sngrep](https://github.com/irontec/sngrep) ⭐ 1,203 | 🐛 73 | 🌐 C | 📅 2026-08-15 - Terminal based SIP flow viewer.
* [WebRTC Troubleshooter](https://github.com/webrtc/testrtc) ⚠️ Archived - Self-hosted one stop client-side WebRTC troubleshooter.
* [sipgrep](https://github.com/sipcapture/sipgrep) ⭐ 176 | 🐛 6 | 🌐 C | 📅 2025-09-10 - Console tool for sniffing, capturing and exploring SIP traffic.
...
* [SIPVicious](https://github.com/EnableSecurity/sipvicious) ⭐ 1,095 | 🐛 0 | 🌐 Python | 📅 2026-07-10 - Suite of security tools that can be used to audit SIP based VoIP systems.
* [sipexer](https://github.com/miconda/sipexer) ⭐ 416 | 🐛 1 | 🌐 Go | 📅 2026-07-17 - Modern and flexible SIP command line tool.
...
* [Fonoster](https://github.com/fonoster/fonoster) ⭐ 8,078 | 🐛 18 | 🌐 TypeScript | 📅 2026-07-16 - Telecommunication stack built with Node.js.
* [Sayna](https://github.com/SaynaAI/sayna) ⭐ 308 | 🐛 0 | 🌐 Rust | 📅 2026-05-31 - Real-time speech infrastructure for voice AI with WebSocket streaming, SIP telephony and pluggable STT/TTS providers.
* [IVOZ Provider](https://github.com/irontec/ivozprovider) ⭐ 226 | 🐛 98 | 🌐 PHP | 📅 2026-08-10 - Multitenant solution for VoIP telephony providers.
...
* [simple-peer](https://github.com/feross/simple-peer) ⭐ 7,806 | 🐛 128 | 🌐 JavaScript | 📅 2024-06-26 - WebRTC video, voice, and data channels abstraction for Node.js and the browser.
...
* [libdatachannel](https://github.com/paullouisageneau/libdatachannel) ⭐ 2,703 | 🐛 147 | 🌐 C++ | 📅 2026-08-07 - Standalone WebRTC DataChannels C++ implementation.
...
* [Sofia-SIP](https://github.com/freeswitch/sofia-sip) ⭐ 349 | 🐛 122 | 🌐 C | 📅 2026-08-03 - Open source SIP library used by FreeSWITCH.
...
* [go-diameter](https://github.com/fiorix/go-diameter) ⭐ 291 | 🐛 9 | 🌐 Go | 📅 2026-07-22 - RFC compliant Diameter protocol library.
...
* [aiortc](https://github.com/aiortc/aiortc) ⭐ 5,085 | 🐛 33 | 🌐 Python | 📅 2026-07-17 - WebRTC and ORTC implementation for Python using asyncio.
...
* [rtcrs/webrtc](https://github.com/rtcrs/webrtc) ⭐ 5,114 | 🐛 14 | 🌐 Rust | 📅 2026-08-13 - WebRTC stack, supporting SDP, RTP, RTCP and SRTP.
...
* [Awesome Cellular Hacking](https://github.com/W00t3k/Awesome-Cellular-Hacking) ⭐ 3,978 | 🐛 2 | 📅 2026-03-21 - Research resources in the 3G/4G/5G Cellular security space.
* [Awesome Telco](https://github.com/ravens/awesome-telco) ⭐ 986 | 🐛 0 | 🌐 Python | 📅 2026-08-08 - Telco resources and projects.
* [Awesome 5G](https://github.com/calee0219/awesome-5g) ⭐ 907 | 🐛 6 | 🌐 Shell | 📅 2026-02-03 - 5G frameworks, libraries, software and resources.
