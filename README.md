...
* [RTP:Engine](https://github.com/sipwise/rtpengine) ⭐ 980 | 🐛 102 | 🌐 C | 📅 2026-08-24 - RTP and UDP based media traffic proxy, usable as a kernel module.
...
* [coturn](https://github.com/coturn/coturn) ⭐ 14,348 | 🐛 314 | 🌐 C | 📅 2026-08-24 - Fully featured TURN/STUN server supporting multiple platforms.
...
* [HOMER](https://github.com/sipcapture/homer) ⭐ 2,007 | 🐛 0 | 🌐 Go | 📅 2026-08-26 - Multi-protocol capturing and monitoring framework for RTC.
...
* [sipexer](https://github.com/miconda/sipexer) ⭐ 416 | 🐛 1 | 🌐 Go | 📅 2026-08-26 - Modern and flexible SIP command line tool.
...
* [Fonoster](https://github.com/fonoster/fonoster) ⭐ 8,080 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-26 - Telecommunication stack built with Node.js.
...
* [adapter.js](https://github.com/webrtcHacks/adapter) ⭐ 3,746 | 🐛 9 | 🌐 JavaScript | 📅 2026-08-23 - JavaScript shim for abstracting WebRTC spec changes and inconsistencies.
...
* [libdatachannel](https://github.com/paullouisageneau/libdatachannel) ⭐ 2,716 | 🐛 147 | 🌐 C++ | 📅 2026-08-07 - Standalone WebRTC DataChannels C++ implementation.
...
* [go-diameter](https://github.com/fiorix/go-diameter) ⭐ 291 | 🐛 12 | 🌐 Go | 📅 2026-07-22 - RFC compliant Diameter protocol library.
...
* [aiortc](https://github.com/aiortc/aiortc) ⭐ 5,093 | 🐛 33 | 🌐 Python | 📅 2026-07-17 - WebRTC and ORTC implementation for Python using asyncio.
...
* [Awesome Cellular Hacking](https://github.com/W00t3k/Awesome-Cellular-Hacking) ⭐ 3,998 | 🐛 2 | 📅 2026-03-21 - Research resources in the 3G/4G/5G Cellular security space.
